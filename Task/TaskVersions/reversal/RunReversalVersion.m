%RUNREVERSALVERSION   This script runs the REVERSAL version of the cannon task.
%
% Documentation
% Unit test
% Contributors
...
unitTest = false;
DataMain = al_ReversalVersion(taskParam, unitTest);
