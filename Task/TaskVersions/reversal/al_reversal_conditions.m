classdef al_reversal_conditions
    ...
    methods
        ...
        function condobj = al_reversal_conditions(cond_init)
...
%         
        ...
        function condobj = ReversalCondition(condobj, taskParam, subject)
            ...
            if condobj.runIntro && ~condobj.unitTest
                ...
                whichPractice = 'reversal';
                al_reversalInstructions(taskParam, subject, true, whichPractice);
                [taskData, trial] = al_loadTaskData(taskParam, 'reversalPractice', condobj.haz(1), condobj.concentration(1)); 
                al_mainLoop(taskParam, condobj.haz(1), condobj.concentration(1), 'reversalPractice', subject, taskData, trial);
            ...
            %end
            taskData = al_generateOutcomesReversal(taskParam, condobj.haz(1), condobj.concentration(1), 'reversal');
           % [taskData, trial] = al_loadTaskData(taskParam, 'reversal', condobj.haz(1), condobj.concentration(1)); 
            [~, condobj.DataReversal] = al_mainLoop(taskParam, condobj.haz(1), condobj.concentration(1), 'reversal', subject, taskData, trial);
        end
