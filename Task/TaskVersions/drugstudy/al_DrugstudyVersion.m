function DataMain = al_DrugstudyVersion(taskParam, unitTest)
%AL_ARCVERSION
%
% XX
...
elseif (isequal(taskType, 'oddball') && isequal(subject.session, '2')) || (isequal(taskType, 'oddball') && isequal(subject.session, '3'))
    ...
    cond = al_drugstudy_conditions(cond_init);
