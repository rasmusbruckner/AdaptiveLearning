...
txtStartTask = ['Sie haben die Übungsphase abgeschlossen. Kurz zusammengefasst fangen Sie also das meiste Konfetti, '...
    ...
    'sehen können, müssen Sie diese Stelle aufgrund der Position der letzten Konfettiwolken einschätzen. Beachten Sie daher, dass Sie das Konfetti trotz '...
    ...
    'Sie werden wie in der Übung zwei Blöcke spielen. In jedem Block gibt es 4 kurze Pausen.\n\nViel Erfolg!'];
