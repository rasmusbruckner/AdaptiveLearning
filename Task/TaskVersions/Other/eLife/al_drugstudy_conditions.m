classdef al_drugstudy_conditions
    ...
    methods
        ...
        function condobj = al_drugstudy_conditions(cond_init)
...
%                         end
            ...
            %[taskData, trial] = al_loadTaskData(taskParam, 'main', condobj.haz(1), condobj.concentration(1)); 
            trial = taskParam.gParam.trials;
            taskData = al_generateOutcomesMain(taskParam, condobj.haz(1), condobj.concentration(1), 'main');
        ...
        function condobj = OddballCondition(condobj, taskParam, subject)
            ...
            if condobj.runIntro && ~condobj.unitTest
                ...
                if isequal(subject.session, '1')
                    ...
                    whichPractice = 'oddballPractice';
                    al_drugstudyInstructions(taskParam, subject, true, whichPractice);
            ...
            trial = taskParam.gParam.trials;
            taskData = al_generateOutcomesOddball(taskParam, condobj.haz(1), condobj.concentration(1), 'oddball');
            [~, condobj.DataOddball] = al_mainLoop(taskParam, condobj.haz(1), condobj.concentration(1), 'oddball', subject, taskData, trial);
        end
    end
end
