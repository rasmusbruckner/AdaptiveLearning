function al_neverWrongInstructions(taskParam)
%AL_NEVERWRONGINSTRUCTIONS This function runs the instructions for the
% how-to-never-be-wrong version of the cannon task
%
%   Input
