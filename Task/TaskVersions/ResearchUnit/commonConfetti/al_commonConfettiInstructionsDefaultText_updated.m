classdef al_commonConfettiInstructionsDefaultText_updated
    ...
    methods
        ...
        function self = al_commonConfettiInstructionsDefaultText_updated(language)
            ...
            % Third practice
            if isequal(self.language, 'German')
                self.thirdPractice = ['Im nächsten Übungsdurchganneedleg wird Ihr Eimer nur noch durch zwei Striche dargestellt. Achten Sie bitte weiterhin besonders darauf, '...
