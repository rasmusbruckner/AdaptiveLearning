classdef al_commonConfettiInstructionsJena
    ...
    methods
        ...
        function self = al_commonConfettiInstructionsJena(language)
            ...
            if isequal(self.language, 'German')
                self.introduceCannon = ['Du blicktst von oben auf eine Konfetti-Kanone, die in der Mitte eines Kreises ist. Deine Aufgabe ist es, das Konfetti mit einem Eimer zu fangen. Mit dem rosafarbenen '...
                    'Punkt kannst du anklicken, wo auf dem Kreis du deinen Eimer platzieren möchtest, um das Konfetti zu fangen. Du kannst den Punkt mit der '...
                    'Maus steuern.'];
            elseif isequal(self.language, 'English')
            ...
            % Introduce confetti
            if isequal(self.language, 'German')
                self.introduceConfetti = 'Das Ziel der Konfetti-Kanone wird mit der schwarzen Linie angezeigt. Steuere den rosafarbenen Punkt auf den Kreis und drücke die linke Maustaste, damit die Konfetti-Kanone schießt.';
            elseif isequal(self.language, 'English')
            ...
            if isequal(self.language, 'German')
                self.introduceSpot = ['Der schwarze Strich zeigt dir die mittlere Position der letzten Konfettiwolke. Der rosafarbene Strich zeigt dir die '...
                    'letzte Position deines Eimers. Steuere den rosafarbenen Punkt jetzt bitte auf das Ziel der Konfetti-Kanone und drücke die linke Maustaste.'];
            elseif isequal(self.language, 'English')
            ...
            % Introduce shield
            if isequal(self.language, 'German')
                self.introduceShield = 'Nach dem Kanonenschuss siehst du den Eimer. Wenn du mindestens die Hälfte des Konfettis im Eimer fangst, zählt es als Treffer und du erhältst einen Punkt.';
            elseif isequal(self.language, 'English')
            ...
            % Introduce miss
            if isequal(self.language, 'German')
                self.introduceMiss = 'Versuche nun, deinen Eimer so zu plazieren, dass du das Konfetti NICHT fängst. Drücke dann die linke Maustaste.';
            elseif isequal(self.language, 'English')
            ...
            if isequal(self.language, 'German')
                self.introducePracticeSession = 'Im Folgenden machst du ein paar Übungsdurchgänge\nund im Anschluss zwei Durchgänge des Experiments.';
            elseif isequal(self.language, 'English')
            ...
            if isequal(self.language, 'German')
                self.firstPractice = ['In diesem Durchgang ist die Konfetti-Kanone schon sehr alt und die Schüsse sind daher ziemlich ungenau. Das heißt, auch wenn '...
                    'du den Eimer genau auf das Ziel der Konfetti-Kanone plazierst, kannst du das Konfetti verfehlen. Die Ungenauigkeit ist zufällig. '...
            ...
            % Reduced
            if isequal(self.language, 'German')
                self.reduceShield = ['Ab jetzt sehst du den Eimer nur noch als zwei Striche. Außerdem siehst du die Aufgabe in weniger Farben. ' ...
                                    'Dies ist notwendig, damit wir deine Pupillengröße gut messen können. Achte daher bitte besonders darauf, '...
                                    'möglichst auf den Punkt in der Mitte des Kreises zu schauen. Bitte versuche Augenbewegungen und blinzeln '...
            ...
            % Second practice
            if isequal(self.language, 'German')
                self.secondPractice = ['Um sicherzugehen, dass du die Aufgabe verstanden hast, machen wir jetzt eine kurze Übung:\n\n'...
            ...
            % Third practice
            if isequal(self.language, 'German')
                self.thirdPractice = ['In dieser Übung siehst du nur noch einen Schuss der Konfetti-Kanone. '...
                    ...
                    'Wenn du denkst, dass die Konfetti-Kanone ihre Richtung geändert hat, solltest du auch den Eimer '...
                    'dorthin bewegen.\n\nBeachte, dass du das Konfetti trotz guter Vorhersagen auch häufig nicht fangen kannst.'];
            elseif isequal(self.language, 'English')
            ...
            % Fourth practice
            if isequal(self.language, 'German')
                self.fourthPractice = ['Jetzt kommen wir zur letzten Übung.\n\nDiesmal musst du mit dem rosafarbenen Punkt deinen Schild platzieren und siehst dabei die Kanone nicht mehr. Außerdem wirst du es sowohl mit einer relativ genauen '...
                    'als auch einer eher ungenauen versteckten Konfetti-Kanone zu tun haben.\n\n'...
                    'Achte bitte auf Augenbewegungen und Blinzeln wie von der Versuchsleitung erklärt.'...
                    '\n\nBeachte bitte auch, dass das Ziel der Konfetti-Kanone in manchen Fällen sichtbar sein wird. In diesen Fällen ist die beste Strategie, zum Ziel der Kanone zu gehen.'];
            elseif isequal(self.language, 'English')
            ...
            % Start task
            if isequal(self.language, 'German')
                self.startTask = ['Toll, du hast die Übungen geschafft! Kurz zusammengefasst fängst du also das meiste Konfetti, '...
                    ...
                    'sehen kannst, musst du diese Stelle aufgrund der Position der letzten Konfettiwolken einschätzen. Beachte, dass du das Konfetti trotz '...
            ...
            % Practice block fail
            if isequal(self.language, 'German')
                self.practiceBlockFail = ['Du hast deinen Eimer oft neben dem Ziel der Kanone platziert. Versuche im nächsten '...
            ...
            % Practice block fail
            if isequal(self.language, 'German')
                self.cannonPracticeFail = ['Du hast die Konfetti-Kanone nicht genau genug eingeschätzt. Versuche im nächsten '...
                'Durchgang bitte, den Mittelpunkt der einzelnen Schüsse auszuwählen. Wenn du Fragen hast, wende dich an die Versuchsleitung.'];
            elseif isequal(self.language, 'English')
            ...
            if isequal(self.language, 'German')
                ...
                self.firstPupilBaseline = ['Du wirst jetzt für drei Minuten verschiedene Farben auf dem Bildschirm sehen. '...
                    'Bitte fixiere deinen Blick währenddessen auf den kleinen Punkt in der Mitte des Bildschirms.'];
            elseif isequal(self.language, 'English')
            ...
            if isequal(self.language, 'German')
                ...
                self.secondPupilBaseline = ['Du wirst jetzt noch mal für drei Minuten verschiedene Farben auf dem Bildschirm sehen. '...
                    'Bitte fixiere deinen Blick währenddessen auf den kleinen Punkt in der Mitte des Bildschirms.'];
            elseif isequal(self.language, 'English')
            ...
            if isequal(self.language, 'German')
                ...
                self.introduceLowNoise = ['Im folgenden Block wird die Konfetti-Kanone relativ genau sein.\n\n'...
                    ...
                    'zu Durchgang ändern. Diese Veränderung kannst du nicht beeinflussen '...
            ...
            self.introducePassiveViewing = ['Versuche bitte in dieser Aufgabe die Mitte '...
                ...
                'Versuche nur zu blinzeln, wenn der weiße Punkt erscheint.'];
        ...
        function self = giveFeedback(self, currPoints, type)
            ...
            elseif isequal(type, 'task')
                if isequal(self.language, 'German')
                    ...
                    self.dynamicFeedbackTxt = sprintf('Vielen Dank für deine Teilnahme!\n\n\nDu hast insgesamt %i Punkte gewonnen!', currPoints);
                elseif isequal(self.language, 'English')
        ...
        function self = giveBlockFeedback(self, nBlocks, half, currBlock)
            ...
            if half == 1
                self.dynamicBlockTxt = sprintf('Kurze Pause!\n\nDu hast bereits %i von insgesamt %i Durchgängen geschafft.', currBlock, nBlocks*2);
            elseif half == 2
                self.dynamicBlockTxt = sprintf('Kurze Pause!\n\nDu hast bereits %i von insgesamt %i Durchgängen geschafft.', currBlock+nBlocks, nBlocks*2);
            else
