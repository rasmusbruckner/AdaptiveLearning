classdef al_ARC_conditions
    ...
    methods
        ...
        function condobj = al_ARC_conditions(cond_init)
            ...
            if condobj.runIntro && ~condobj.unitTest
                ...
                if strcmp(subject.session,'1')
                    ...
                    if condobj.cBal == 1 || condobj.cBal == 3
                        ...
                        trial = taskParam.gParam.practTrials;
                        % ------------------------------------
                        %[taskData, trial] = al_loadTaskData(taskParam, 'mainPractice_4', condobj.haz(3), condobj.concentration(2)); 
        ...
        function condobj = ARC_ControlCondition(condobj, c_condition, taskParam, subject, ~)
            ...
            % ----
            [~, ~] =  al_mainLoop(taskParam, taskParam.gParam.haz(2), taskParam.gParam.concentration(3), condition, subject, taskData, trial);
            ...
            taskData.initialTendency = nan(trial,1); 
            % ----
            [~, condobj.Data] =  al_mainLoop(taskParam, taskParam.gParam.haz(2), taskParam.gParam.concentration(3), condition, subject, taskData, trial);
