classdef al_subject
    ...
    methods
        ...
        function checkRew(self)
            ...
            %variable
            %
            %   If reward is incorrectly specified, the function returns
            %   an error.
            %
            %   Input
            %       self: Subject object
        ...
        function checkStartsWithBlock(self, nBlocks)
            %CHECKSTARTSWITHBLOCK This function tests input related to the
            %startsWithBlock variable
            %
            %   If startsWithBlock is larger than nBlocks, the function returns
            %   an error.
            %
            %   Input
            %       self: Subject object
            ...
            if self.startsWithBlock > nBlocks
                error('startsWithBlock must be smaller than nBlocks!')
            end
