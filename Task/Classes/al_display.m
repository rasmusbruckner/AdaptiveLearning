    ...
    methods
        ...
        function displayobj = openWindow(displayobj, gParam)
            ...
            if gParam.debug == true
                ...
                [displayobj.window.onScreen, displayobj.windowRect] = Screen('OpenWindow', gParam.screenNumber-1, displayobj.backgroundCol, []); % displayobj.screensize% [] %  1    1    2560    1440  1    1    2560 1440 1707.6    9602560x1440   66 66 66
            end
