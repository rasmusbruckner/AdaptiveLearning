function MainAndFollowCannon_CannonVisibleNoNoise(whichPractice, taskParam, subject)
...
%                         fw = al_bigScreen(taskParam, taskParam.strings.txtPressEnter, header, txt, feedback);
                        ...
                        %taskData = al_generateOutcomesOddball(taskParam, taskParam.gParam.haz(1), taskParam.gParam.concentration(3), condition);
                        % ------
