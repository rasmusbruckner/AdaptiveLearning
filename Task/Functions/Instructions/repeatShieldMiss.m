function taskData = repeatShieldMiss(taskParam, taskData, trial, txt)
...
%al_cannonball(taskParam, taskData.distMean(trial), outcome, background, 1, 0, 1, taskData, absTrialStartTime)
 ...
 %               screenIndex = screenIndex - 5;
    ...
    if isequal(taskParam.gParam.taskType, 'dresden')
        if isequal(taskParam.subject.group, '1')
            ...
            txt = 'Der schwarze Balken zeigt Ihnen wie weit die Kanonenkugel von Ihrem Punkt entfernt war. Daraufhin siehst sehen Sie dann...';
        end
