    ...
    switch(screenIndex)
        case 1
            ...
            txt = ['Zum Abschluss kommt eine Aufgabe um deine Genauigkeit zu untersuchen. Hier sollst du den '...
                ...
                'schwarzen Balkens.\n\n'...
                'Diesmal verdienst du 10 CENT, wenn dein blauer Punkt auf der Stelle der letzten Kanonenkugel war UND wenn du eine goldene Kugel siehst. '...
        ...
        case 4
            ...
            sumCannonDev = sum(taskData.memErr(2:end) >= 5)
            if sumCannonDev >= 2
            ...
            if subject.rew == '1'
                if isequal(taskParam.gParam.computer, 'D_Pilot')
                    txt = ['Denke daran, dass du den blauen Punkt ab jetzt immer auf '...
                        'die letzte Position der Kanonekugel steuerst. Wenn du genau '...
                        'genug bist, bekommst du...\n\n'...
                        'Goldene Kugel: 10 CENT\n\nEiserne Kugel: Hier verdienst du '...
                        'leider nichts.'];
