...
if (isequal(condition, 'oddballPractice') && practData.oddBall(i) == true)
    WaitSecs(0.5)
elseif isequal(condition, 'shield') || isequal(condition, 'followOutcomePractice') || isequal(condition, 'oddballPractice') || isequal(condition, 'oddballPractice_NoOddball') || isequal(condition, 'mainPractice')
