...
if isequal(taskParam.gParam.computer, 'Humboldt')
    txt = ['Der Radar zeigt dir die Position der Schiffsflotte leider '...
          'nur ungefähr an.\n\nDurch den Seegang kommt es oft vor, dass '...
          'die Schiffe nur in der Nähe\n\nder angezeigten Position '...
          'sind. Manchmal sind sie etwas weiter links\n\nund manchmal '...
          'etwas weiter rechts. Diese Abweichungen von der\n\n '...
...
if isequal(taskParam.gParam.computer, 'Humboldt')
    txt=['Mit LEERTASTE gibst du einen Schuss ab. Richte dich dabei'...
         'nach\n\nder Radarnadel. Beachte, dass der Radar dir durch'...
...
if isequal(taskParam.gParam.computer, 'Humboldt')
    txt = ['Es ist wichtig, dass du während der Aufgabe'...
           'immer auf das\n\nFixationskreuz schaust.'...
           'Wir bitten dich darum, möglichst wenige\n\nAugenbewegungen'...
           'zu machen. Versuche außerdem wenig zu blinzeln.\n\nWenn du'...
...
if isequal(taskParam.gParam.computer, 'Humboldt')
    txt= ['Im nächsten Übungsdurchgang fahren die Schiffe ab und zu '...
          ...
          'vorhersagen. Wenn dir\n\ndie Radarnadel eine neue Position'...
...
if isequal(taskParam.gParam.computer, 'Humboldt')
    txt = ['In der folgenden Übung ist dein Radar leider kaputt. '...
           ...
           'selber herausfinden. Trotzdem solltest du\n\nversuchen, '...
