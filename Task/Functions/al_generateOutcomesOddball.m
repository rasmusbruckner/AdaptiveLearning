function taskData = al_generateOutcomesOddball(taskParam, haz, concentration, condition)
%AL_GENERATEOUTCOMES   This function generates the outcomes for the oddball
%   condition
%
%   NOTE: The function is currently under construction
%
%   Input
...
elseif isequal(condition, 'oddball') || isequal(condition, 'practiceNoOddball') || isequal(condition, 'practiceOddball')
    ...
    for i = 1:trials
        ...
        % Extract probability of oddball trials
