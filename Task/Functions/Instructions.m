            ...
            switch(screenIndex)
                ...
                case 2
                    ...
                    [taskParam, practData] = PractLoop(taskParam, subject,...
                        taskParam.gParam.vola(1), taskParam.gParam.concentration(3),...
        ...
        while 1
            ...
            switch(screenIndex)
                ...
                case 2
                    ...
                    [taskParam, practData] = PractLoop(taskParam, subject,...
                        taskParam.gParam.vola(1), taskParam.gParam.concentration(1),...
                        cannon, condition,LoadData);
        ...
        while 1
            ...
            switch(screenIndex)
                ...
                case 2
                    ...
                    %        taskParam.gParam.concentration(1), cannon, condition);
                    %elseif taskParam.gParam.oddball == true
                ...
                case 4                                                           % Show performance.
                    ...
                    LoadData = 'NoNoise';
                    [taskParam, practData] = PractLoop(taskParam, subject,...
                        taskParam.gParam.vola(3), taskParam.gParam.concentration(3),...
                        cannon, condition, LoadData);
                    %end
                    % elseif isequal(type, 'Main')
                    %                         condition = 'practice';
                ...
                case 7
                    ...
                    elseif taskParam.gParam.oddball == true
                        ...
                        LoadData = 'Noise';
                        [taskParam, practData] = PractLoop(taskParam, subject,...
                            taskParam.gParam.vola(3), taskParam.gParam.concentration(1),...
                            cannon, condition, LoadData);
                    end
                    %elseif isequal(type, 'Main')
