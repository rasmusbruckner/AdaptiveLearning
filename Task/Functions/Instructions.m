        ...
        while 1
            ...
            switch(screenIndex)
                ...
                case 8
                    ...
                    [screenIndex, Data, t] = InThisCaseYouMissedTheCannonball(screenIndex, Data, t, txt, distMean);
                    
                case 9
                    
                     [screenIndex, Data] = YourShield(screenIndex, Data);
...
%                     WaitSecs(0.1);
    ...
    function [screenIndex, Data] = AfterCannonIsShotYouSeeTheShield(screenIndex, Data, txt, distMean)
                    %distMean = 290;
                    outcome = distMean;
                    LineAndBack(taskParam)
                    DrawCircle(taskParam);
...
%         end
    ...
    function [screenIndex, Data, t] = InThisCaseYouMissedTheCannonball(screenIndex, Data, t, txt, distMean)
...
%             end
    ...
    function[screenIndex, Data] = YourShield(screenIndex, Data)
                     if taskParam.gParam.oddball == false
                        header = 'Das Schild';
