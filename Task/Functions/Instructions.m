            ...
            switch(screenIndex)
                ...
                case 2
                    ...
                    [taskParam, practData] = PractLoop(taskParam, subject,...
                        taskParam.gParam.haz(1), taskParam.gParam.concentration(3),...
        ...
        while 1
            ...
            switch(screenIndex)
                ...
                case 5
                    ...
                    %             if subject.cBal == '2'
                    %                 if taskParam.gParam.runhaz == false
                    %                     hazIndication(taskParam,...
                    %                         taskParam.strings.txtHighhaz,...
                ...
                case 7
                    ...
                    elseif taskParam.gParam.oddball == true
                        ...
                        LoadData = 'Noise';
                        [taskParam, practData] = PractLoop(taskParam, subject,...
                            taskParam.gParam.haz(3), taskParam.gParam.concentration(1),...
                            cannon, condition, LoadData);
                    end
                    %elseif isequal(type, 'Main')
