...
%% Save data
taskData = struct(fieldNames.actJitter, actJitter, fieldNames.block, block, fieldNames.initiationRTs, initiationRT,...
    fieldNames.timestampOnset, timestampOnset, fieldNames.timestampPrediction, timestampPrediction,...
    fieldNames.timestampOffset, timestampOffset, fieldNames.oddBall, oddBall, fieldNames.allASS, allASS,...
    fieldNames.ID, {ID}, fieldNames.age, {age}, fieldNames.rew, {rew}, fieldNames.actRew, actRew, fieldNames.sex,...
    {sex}, fieldNames.cond, {cond}, fieldNames.trial, i,...
