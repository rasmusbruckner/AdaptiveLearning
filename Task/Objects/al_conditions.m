classdef al_conditions
    ...
    methods
        ...
        function condobj = al_conditions(cond_init)
            % CONDOBJ creates a conditions object of class
            % al_conditions
        ...
        function condobj = MainCondition(condobj, taskParam, subject)
            ...
            if condobj.runIntro && ~condobj.unitTest
                ...
                switch condobj.taskType
                    ...
                    case 'dresden'
                        ...
                        % Run main task
                        al_mainLoop(taskParam, condobj.haz(3), condobj.concentration(1),...
                            'mainPractice', subject);
                        feedback = false;
                        al_bigScreen(taskParam, condobj.txtPressEnter, condobj.header,...
                    ...
                    case 'ARC'
                        ...
                        if strcmp(subject.session,'1')
                            ...
                            if condobj.cBal == 1 || condobj.cBal == 3
                                ...
                                al_mainLoop(taskParam, condobj.haz(3), condobj.concentration(2),...
                                    'mainPractice_4', subject);
                                
                            elseif condobj.cBal == 2 || condobj.cBal == 4
                                
                                ARC_indicateCondition('highNoise', taskParam, condobj.txtPressEnter)
                                al_mainLoop(taskParam, condobj.haz(3), Zconcentration(2),...
                                    'mainPractice_4', subject);
            ...
            function ARC_indicateCondition(condition, taskParam, txtPressEnter)
                ...
                if strcmp(condition, 'lowNoise')
                    ...
                    txtStartTask_ind = ['In this block of trials the cannon '...
        ...
        function condobj = ARC_ControlCondition(condobj, c_condition, taskParam, subject, ~)
            ...
            taskParam.gParam.showTickmark = false;
            [~, condobj.Data] =  al_mainLoop(taskParam,...
                taskParam.gParam.haz(2),...
                taskParam.gParam.concentration(3),...
                condition, subject);
        ...
        function condobj = ChineseCondition(condobj, taskParam, subject)
            ...
            if condobj.runIntro && ~condobj.unitTest
                ...
                condobj.Data = al_mainLoop(taskParam, condobj.haz(1),...
                    condobj.concentration(1), 'chinesePractice_4', subject);
            ...
            [~, condobj.DataChinese] = al_mainLoop(taskParam,...
                condobj.haz(1), condobj.concentration(1),...
                'chinese', subject);
        end
        ...
        function DataReversal = ReversalCondition(runIntro, unitTest, haz, concentration, txtPressEnter)
            ...
            if runIntro && ~unitTest
                ...
                al_mainLoop(taskParam, haz(1), concentration(1),...
